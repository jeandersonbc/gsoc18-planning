...
\event{Jul/06 - Jul/14}{Code submission and final evaluation}
...
\todo{not only describe like in XML in JSON, but actually specify how tasks can
be performed with actual code.}
...
\todo{...}
Therefore, \textbf{\maven{} and \gradle{} win in terms of maturity and
popularity}.
\end{itemize}
...
\gradle{} combines the best of both alternatives and some other features.
For instance, it features incremental building, a daemon to speedup future
executions, and also a convenient \emph{wrapper}
