...
JPF community.
\todo{next section describes the tasks and the appendix elaborates how I decide
to choose gradle}

\section{Evaluating Build Tools}
\label{sec:eval}

\fix{move evaluation and results to an appendix. this proposal already assumes
Gradle and the mentor what's to know what I'm going to do in this project. the
curious reader may want to refer to the appendix if she wants to know how I
came up with \gradle{}}
