...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \lstinputlisting{snippets/ant-gradle-integration/build.xml}
        \caption{\texttt{build.xml} file}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \lstinputlisting{snippets/ant-gradle-integration/console.txt}
        \caption{Console output}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \vspace{3mm}
        \lstinputlisting{snippets/ant-gradle-integration/build.gradle}
        \caption{\texttt{build.gradle} file}
    \end{subfigure}
...
This is feasible because \gradle{} interchangeably handles \ant{} targets and \gradle{} tasks.
\todo{figure illustrating this...}.
\todo{description}.
